function drawBarChart(data) {
    let prepedSentimentData = PrepareData(data.hashtagData);
    let noOfQueries = data.importantWords.length;

    // Set up variables for the Bar Chart function
    let sentimentChart = StackedBarChart(prepedSentimentData, {
        x: d => d.proportion,
        y: d => d.hashtag,
        z: d => d.sentiment,
...
function TidyTree(data, {
    ...
    node.append("circle")
        .attr("fill", d => d.children ? "#1DA1F2" : "#1DA1F2")
        .attr("r", 2.5);
